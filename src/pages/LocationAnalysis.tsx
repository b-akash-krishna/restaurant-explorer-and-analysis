...
function LocationAnalysis() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-red-50 via-orange-50 to-yellow-50 flex items-center justify-center p-4">
        <div className="bg-white/95 backdrop-blur-md shadow-2xl rounded-2xl p-8 w-full max-w-2xl border border-red-200">
          <div className="flex items-center justify-center mb-6">
            <Loader2 className="w-12 h-12 text-red-500 animate-spin" />
          </div>
          <p className="text-center text-gray-600">Loading location analysis...</p>
        </div>
      </div>
    );
  }
  ...
  if (error) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-red-50 via-orange-50 to-yellow-50 flex items-center justify-center p-4">
        <div className="p-6 bg-red-50 border-2 border-red-200 rounded-xl max-w-md">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-red-50 via-orange-50 to-yellow-50">
      ...
      >
        <div className="absolute inset-0 bg-gradient-to-r from-red-900/90 via-orange-800/85 to-yellow-900/90"></div>
        <div className="relative max-w-7xl mx-auto px-4">
          ...
          <p className="text-center text-orange-100 text-lg max-w-2xl mx-auto drop-shadow-md">
            Explore geospatial visualizations and analyze restaurant distributions across different cities
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 pb-8">
        ...
        {/* Tabs Navigation */}
        <div className="bg-white/95 backdrop-blur-sm shadow-xl rounded-2xl overflow-hidden mb-6 border border-red-100">
          ...
          <div className="p-6 bg-gradient-to-br from-white to-red-50/20">
            {activeTab === 'overview' && data?.insights && (
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                  <div className="bg-gradient-to-br from-red-50 to-red-100 p-6 rounded-xl border border-red-200 shadow-md hover:shadow-xl transition-all">
                  ...
                  <div className="bg-gradient-to-br from-orange-50 to-orange-100 p-6 rounded-xl border border-orange-200 shadow-md hover:shadow-xl transition-all">
                    <div className="flex items-center mb-3">
                  ...
                  <div className="bg-gradient-to-br from-green-50 to-green-100 p-6 rounded-xl border border-green-200 shadow-md hover:shadow-xl transition-all">
                    <div className="flex items-center mb-3">
                ...
                <div className="bg-white/80 backdrop-blur-sm p-6 rounded-xl border border-red-100 shadow-md">
                  <h3 className="font-semibold text-gray-900 mb-4 text-lg">Restaurant Distribution</h3>
              ...
              <div className="space-y-6">
                <div className="flex flex-col md:flex-row gap-4 items-end">
                  <div className="flex-1">
                    ...
                    <input
                      ...
                      className="w-full px-4 py-2 border-2 border-gray-200 rounded-xl focus:ring-4 focus:ring-red-100 focus:border-red-500 transition-all duration-200"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="px-4 py-2 border-2 border-gray-200 rounded-xl focus:ring-4 focus:ring-red-100 focus:border-red-500 transition-all duration-200"
                    >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {filteredCities.map((city, index) => (
                    <div
                      key={city.city}
                      className="border-2 border-gray-200 rounded-xl p-5 hover:shadow-xl transition-all hover:border-red-300 bg-white hover:-translate-y-1 duration-300"
                    >
              ...
              <div className="space-y-6">
                ...
                <div className="bg-blue-50 border-2 border-blue-200 rounded-xl p-4">
                  <p className="text-sm text-blue-800 font-medium">
                    Viewing {filteredLocalities.length} localities in {selectedCity}
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {filteredLocalities.map((locality, index) => (
                    <div
                      key={index}
                      className="border-2 border-gray-200 rounded-xl p-4 hover:shadow-xl transition-all bg-white hover:border-red-300 hover:-translate-y-1 duration-300"
                    >
                      <div className="flex items-start justify-between mb-3">
                        <div className="flex-1">
            ...
            {activeTab === 'map' && (
              <div className="space-y-4">
                ...
                {mapData.length > 0 ? (
                  <div className="h-[600px] rounded-xl overflow-hidden border-2 border-red-200 shadow-xl">
                    <MapContainer
                      center={mapCenter}
                      zoom={12}
